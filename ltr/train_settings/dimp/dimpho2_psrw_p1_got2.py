...
def run(settings):
    ...
    dataset_train = sampler.DiMPSampler(#[lasot_train, got10k_train, trackingnet_train, coco_train], [0.25,1,1,1],
                                        [got10k_train],[1],
                                        samples_per_epoch=26000, max_gap=100, num_test_frames=3, num_train_frames=3,
    ...
    dataset_val = sampler.DiMPSampler([got10k_val], [1], samples_per_epoch=5000, max_gap=100,

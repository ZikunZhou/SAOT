# testing param compatible to the new training settings
...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='please set the model path',
                                 use_gpu=params.use_gpu)

    params.vot_anno_conversion_type = 'preserve_area'

    params.subsearch_feat_sz = 22
    ...
    # tune the following configs with tune_fs.py if needed
    # params.perform_post_process = True
    # params.WINDOW_INFLUENCE = 
    # params.PENALTY_K = 
    # params.LR = 

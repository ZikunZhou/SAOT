...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, run_id: int = None, display_name: str = None,
        ...
        env = env_settings()
        results_dir = '{}/{}/{}/{}/{}'.format(env.results_path, self.name, self.parameter_name,
        ...
        if self.run_id is None:
            ...
            self.results_dir = '{}_{:03d}'.format(self.results_dir, self.run_id)
            self.segmentation_dir = '{}_{:03d}'.format(self.segmentation_dir, self.run_id)
    ...
    def run_vot_pysot(self, debug=None, visdom_info=None):
        """ Run on vot"""
        visdom_info = {} if visdom_info is None else visdom_info
        params = self.get_parameters()
    ...
    def run_otb_pysot(self, debug=None, visdom_info=None):
        """ Run on otb with pysot"""
        visdom_info = {} if visdom_info is None else visdom_info
        params = self.get_parameters()
